...
export const workExperience: WorkExperience[] = [
  {
    ...
    description: <span>
        I served my National Service obligations as a Software Support Assistant (colloquially an AI Engineer / Researcher) at the <a href="https://rsaf-agile-inno-digital.defence.gov.sg/">RSAF Agile Innovation Digital (RAiD)</a>, under their Experimentations branch, <a href="https://maps.app.goo.gl/GLhfqexgm6xFeuRS9">AETHER</a>.
        <br/><br/>
        ...
        <ul className="list-disc pl-4">
            <li className="mb-2">Investigating research methods to monitor cognitive states of controllers via psychophysiological monitors such as EEG and eye-tracking data, experimenting with foundation models, JEPA and more.<br/><small>with <a href="https://www.linkedin.com/in/wuglenn/">Glenn Wu</a> and <a href="https://www.linkedin.com/in/sohan-daniel-singh-1b3831235/">Sohan Singh</a></small></li>
            ...
            <li>Developing decision support systems for training and operations purposes.</li>
        </ul>
        <br/>
        On the A3 side, I co-led a small team developing agentic AI-based solutions to optimize the lab's general finance, manpower and logistics operations. We built <b>🛦 Wingman</b>, a centralized desktop application for hosting all our AI agents in a centralised manner.<br/>
