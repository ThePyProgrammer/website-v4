          ...
          <div className="mx-auto grid lg:max-w-4xl gap-8 lg:gap-24 lg:grid-cols-2">
            <div className="max-w-2xl text-muted-foreground mb-8">
              <p className="mb-4">
                ...
                I recently completed my National Service at the <a href="https://www.rsaf.gov.sg/raid/">RSAF Agile Innovation Digital (RAiD)</a> as an AI Researcher under the AETHER Branch.
