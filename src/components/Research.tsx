    ...
    const researchProjects: ResearchProject[] = [
        ...
        },
        {
            ...
            description: <>
                ...
                <p>
                    We finally submitted <a href="/papers/parkinsons.pdf">this work</a> (which has not yet been published) to the <a href="https://www.science.edu.sg/for-schools/competitions/singapore-science-and-engineering-fair">SSEF 2023</a>, where we once again attained the Gold Award, as well as the SUTD Research and Innovation Award  in Healthcare. We were also selected to present this work at the <a href="https://issf2023.com/">International Student Science Fair (ISSF) 2023</a> in Brisbane, and we attained 1st Place within the Computing & Mathematics category.
                </p>
                <p>
